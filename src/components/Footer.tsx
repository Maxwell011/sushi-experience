const Footer = () => {
  return (
    <>
      <footer className="p-6 bg-[ #FAFAFA] text-base-content flex flex-col items-center lg:flex-row">
        <aside>
          ...
          <p className="text-[#555] text-sm not-italic font-medium w-[302px] font-inter">
