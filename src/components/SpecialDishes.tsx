      ...
      <section className="mt-24 mb-24">
        <div className="">
          ...
          <div className="flex justify-between items-center mx-[90px]">
            <h1 className="text-normal-black text-lg lg:text-3xl font-bold w-[453px] font-inter">
...
const DishesItem = ({
  ...
  return (
    <div className="shadow-[2px_9px_42px_0px_rgba(0,0,0,0.12)] w-[300px] h-[400px] rounded-[40px] flex items-center flex-col justify-center">
